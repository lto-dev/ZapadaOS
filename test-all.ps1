...
function Test-X86_64 {
    ...
    $checks  = @(
        ...
        "Phase ordered root layout gate",
        "Phase disk assembly load gate",
        "Phase FAT32 mounted at /mnt/c gate",
        "Phase FAT32 mounted at /mnt/d gate",
        "Phase multi-disk storage gate",
        "Phase DevFs gate",
        "Phase DevConsole gate",
        "Phase ProcFs gate",
        "Boot command line smoke mode",
        "Boot init target default",
        "Boot runlevel default",
        "Boot minid target pending notice",
        ...
        "Shell /boot listing command",
        "Shell /boot/zapada listing command",
        "Shell /lib listing command",
        "Shell /lib/dotnet listing command",
        "Shell /lib/zapada listing command",
        "Shell /bin listing command",
        "Shell /sbin listing command",
        ...
        "Shell minid config cat command",
    ...
    $patterns = @(
        ...
        "[Gate] Phase-RootLayout",
        "[Boot] disk assembly loaded from /bin/Zapada.Test.Hello.dll id=",
        "[Gate] Phase-DiskAssemblyLoad",
        "[Gate] Phase-Fat32MntC",
        "[Gate] Phase-Fat32MntD",
        "[Gate] Phase-MultiDiskStorage",
        "[Gate] Phase-DevFs",
        "[Gate] Phase-DevConsole",
        "[Gate] Phase-ProcFs",
        "[Boot] command line: --smoke",
        "[Boot] init target: /sbin/Zapada.Minid.dll",
        "[Boot] runlevel: 3",
        "[Boot] minid init target selected; launch substrate pending",
        ...
        "[Shell] $ ls /boot",
        "<dir>  zapada",
        "[Shell] $ ls /boot/zapada",
        "<file> Zapada.Boot.dll",
        "[Shell] $ ls /lib",
        "<dir>  dotnet",
        "<dir>  zapada",
        "[Shell] $ ls /lib/dotnet",
        ...
        "[Shell] $ ls /lib/zapada",
        "<file> Zapada.Storage.dll",
        "<file> Zapada.Fs.Vfs.dll",
        "<file> Zapada.Drivers.dll",
        "[Shell] $ ls /bin",
        "<file> Zapada.Shell.dll",
        "[Shell] $ ls /sbin",
        "[Shell] $ ls /mnt/c",
        "[Shell] $ ls /mnt/d",
        "[Shell] $ ls /dev",
