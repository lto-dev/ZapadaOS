/*
 * Zapada - src/managed/Zapada.Boot/BufHelper.cs
 *
 * Pure-managed byte buffer extraction helpers.
 *
 ...
 *   The int[] element data starts at a 4-byte-aligned offset (16 bytes
 *   past the managed array header, which is also 4-byte aligned).
